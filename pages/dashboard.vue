          ...
          <div class="card-body">
            <div class="d-flex mb-4 mt-3">
              ...
              <div class="">
                ...
                <p class="fw-normal fs-12">
                  <span class="text-success">3.5%</span> increased
                </p>
              </div>
            ...
            <div class="d-flex">
              ...
              <div class="">
                ...
                <p class="fw-normal fs-12">
                  <span class="text-success">1.2%</span> increased
                </p>
              </div>
              <div class="ms-auto my-auto">
            ...
            <ul class="task-list">
              <li class="d-sm-flex">
                <div>
                  ...
                  <h6 class="fw-semibold">
                    Task Finished<span class="text-muted fs-11 ms-2 fw-normal"
                      >09 July 2021</span
                    >
                  </h6>
              ...
              <li class="d-sm-flex">
                <div>
                  ...
                  <h6 class="fw-semibold">
                    New Comment<span class="text-muted fs-11 ms-2 fw-normal"
                      >05 July 2021</span
                    >
                  </h6>
                  <p class="text-muted fs-12">
              ...
              <li class="d-sm-flex">
                <div>
                  ...
                  <h6 class="fw-semibold">
                    Task Overdue<span class="text-muted fs-11 ms-2 fw-normal"
                      >14 June 2021</span
                    >
                  </h6>
                    ...
                    <td class="text-start p-4">
                      <span
                        ...
                        >
                          ...
                          /></svg></span
                      ><span class="mobile">Mobiles</span>
                    </td>
                    <td class="p-4">17%</td>
                    <td class="p-4">22%</td>
                    <td class="p-4">11%</td>
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      ...
                      <span class="text-success fs-11"
                        >(<i class="fe fe-arrow-up"></i>12.75%)</span
                      >
                    </h6>
                  </div>
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      ...
                      <span class="text-danger fs-11"
                        >(<i class="fe fe-arrow-down"></i>15.12%)</span
                      >
                    </h6>
                  </div>
                  <div class="progress h-2 mb-3">
                ...
                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      25,364
                      <span class="text-success fs-11"
                        >(<i class="fe fe-arrow-down"></i>24.37%)</span
                      >
                    </h6>
                  </div>
                  <div class="progress h-2 mb-3">
                ...
                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      14,635
                      <span class="text-success fs-11"
                        >(<i class="fe fe-arrow-down"></i>15.63%)</span
                      >
                    </h6>
                  </div>
                  <div class="progress h-2 mb-3">
                ...
                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      15,453
                      <span class="text-danger fs-11"
                        >(<i class="fe fe-arrow-down"></i>23.70%)</span
                      >
                    </h6>
                  </div>
                  <div class="progress h-2 mb-3">
                ...
                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                  ...
                  >
                    ...
                    <h6 class="fw-semibold mb-1">
                      10,054
                      <span class="text-success fs-11"
                        >(<i class="fe fe-arrow-up"></i>11.04%)</span
                      >
                    </h6>
                  </div>
                  <div class="progress h-2 mb-3">
                  ...
                  <div class="tab-menu-heading border-0 p-0">
                    <div class="tabs-menu1">
                      ...
                      <ul class="nav panel-tabs product-sale">
                        ...
                        <li>
                          <a href="#tab8" data-bs-toggle="tab" class="text-dark"
                            >Cancelled</a
                          >
                        </li>
                      </ul>
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      ...
                                      style="
                                        background-image: url(../assets/images/orders/10.jpg);
                                      "
                                    ></span>
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/12.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/4.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/8.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/6.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/1.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/11.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
                                ...
                                <td>
                                  <div class="d-flex">
                                    <span
                                      class="avatar bradius"
                                      style="
                                        background-image: url(../assets/images/orders/2.jpg);
                                      "
                                    ></span>
                                    <div class="ms-3 mt-0 mt-sm-2 d-block">
                                      <h6 class="mb-0 fs-14 fw-semibold">
